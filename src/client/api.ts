/**
 * Client-side API wrapper over the mounted `skillManager` Remote namespace.
 *
...
/** The mounted `skillManager` namespace surface. */
...
function namespace(): SkillManagerNamespace {
  ...
  if (ns === undefined) {
    throw new Error('skill-manager: skillManager Remote namespace is not mounted')
  }
  return ns
}
